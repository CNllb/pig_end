...
Page({
  ...
  clicked_card_1: function () {
    var that = this;
    this.data.last_value = this.data.now_value;
    var temp_pork = this.data.player_card_black_peach.pop();
    this.data.now_pork = temp_pork;
    this.data.now_value = this.data.now_pork.value;
    this.data.set_pork_set.push(temp_pork);
    this.data.player_card_black_peach.push();
    console.log("last_value:" + this.data.last_value);
    console.log("now_value:" + this.data.now_value);
    if (this.data.now_index % 2 == 0) {
      this.setData({
        player1_card_black_peach : this.data.player_card_black_peach
      })
    } else {
      this.setData({
        player1_card_black_peach : this.data.player_card_black_peach
  ...
  clicked_card_2: function () {
    var that = this;
    this.data.last_value = this.data.now_value;
    var temp_pork = this.data.player_card_red_heart.pop();
    this.data.now_pork = temp_pork;
    this.data.now_value = this.data.now_pork.value;
    this.data.set_pork_set.push(temp_pork);
    if (this.data.now_index % 2 == 0) {
      this.setData({
        player1_card_red_heart : this.data.player_card_red_heart
      })
    } else {
      this.setData({
        player2_card_red_heart : this.data.player_card_red_heart
      })
    }
    console.log("last_value:" + this.data.last_value);
    console.log("now_value:" + this.data.now_value);
  ...
  clicked_card_3: function () {
    var that = this;
    this.data.last_value = this.data.now_value;
    var temp_pork = this.data.player_card_black_flower.pop();
    this.data.now_pork = temp_pork;
    this.data.now_value = this.data.now_pork.value;
    this.data.set_pork_set.push(temp_pork);
    console.log("last_value:" + this.data.last_value);
    ...
    if (this.data.now_index % 2 == 0) {
      this.setData({
        player1_card_black_flower : this.data.player_card_black_flower
      })
    } else {
      this.setData({
        player2_card_black_flower : this.data.player_card_black_flower
      })
    }
    that.set_pork()
    this.setData({
  ...
  clicked_card_4: function () {
    var that = this;
    this.data.last_value = this.data.now_value;
    var temp_pork = this.data.player_card_red_block.pop();
    this.data.now_pork = temp_pork;
    this.data.now_value = this.data.now_pork.value;
    this.data.set_pork_set.push(temp_pork);
    console.log("last_value:" + this.data.last_value);
    ...
    if (this.data.now_index % 2 == 0) {
      this.setData({
        player1_card_red_block:this.data.player_card_red_block
      })
    } else {
      this.setData({
        player1_card_red_block:this.data.player_card_red_block
  ...
  set_pork:function () {
    ...
    this.setData({
      player_black_peach_count: this.data.player_card_black_peach.length,
      player_black_peach: this.data.player_card_black_peach.pop(),
      player_red_heart_count: this.data.player_card_red_heart.length,
      player_red_heart: this.data.player_card_red_heart.pop(),
      player_black_flower_count: this.data.player_card_black_flower.length,
      player_black_flower: this.data.player_card_black_flower.pop(),
      player_red_block_count: this.data.player_card_red_block.length,
      player_red_block: this.data.player_card_red_block.pop()
    })
    if (this.data.player_black_peach != null) {
      this.data.player_card_black_peach.push(this.data.player_black_peach)
    }
    if (this.data.player_red_heart != null) {
      this.data.player_card_red_heart.push(this.data.player_red_heart)
    }
    if (this.data.player_black_flower != null) {
      this.data.player_card_black_flower.push(this.data.player_black_flower)
    }
    if (this.data.player_red_block != null) {
      this.data.player_card_red_block.push(this.data.player_red_block)
    }
  },
